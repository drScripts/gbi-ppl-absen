<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Token &raquo; {{ $tokens->id }} &raquo; Edit
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div>
                ...
                @endif
                <form action="{{ route('googleToken.update',$tokens->id) }}" class="w-full" method="POST"
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <input id='grid-refresh' value="{{ old('refresh_token') ?? $tokens->refresh_token }}"
                                name="refresh_token"
                        ...
                        <div class="w-full mt-8 px-3">
                            ...
                            <input id="grid-code" value="{{ old('access_token') ?? $tokens->access_token }}"
                                name="access_token"
                                class="appearance-none block w-full bg-gray-200 text-gray-700 rounded-xl focus:outline-none focus:bg-white"
